...
//     if (number % 2 === 1) resolve({ id: 1, balance: 2000 });
//     else reject(new Error("계좌에 접근 불가능"));
//   }, 2000);
// });
...
//   const users = [{ id: 1, githubID: "LEE" }, { id: 2, githubID: "KIM" }];
...
//   console.log("GitHub 리포를 찿는 중입니다.");
//   const repos = [
//     { githubID: "bint", commitID: 1 },
...
function getCommit(commitID) {
  ...
  return new Promise((resolve, reject) => {
    setTimeout(() => {
      ...
      else reject(new Error("커밋을 찾을 수 없음"));
    }, 2000);
  });
}
getUser(1)
